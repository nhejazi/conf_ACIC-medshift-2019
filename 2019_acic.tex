...
\begin{itemize}
  \itemsep0.25pt
  \item \textbf{N.~Hejazi}, Ph.D.~candidate, \textsc{nhejazi@berkeley.edu}
  \item \textbf{M.~van der Laan}, Prof.~of Biostatistics \& Statistics,
    \textsc{laan@berkeley.edu}
  \item \textbf{I.~Diaz}: Asst.~Prof.~of Biostatistics,
    \textsc{ild2005@med.cornell.edu}
\end{itemize}
}
